...
| **[GOAL-01](#goal-01-ai-receipt--smart-inbox-scanner)** | **اسکن هوشمند رسید (Smart Inbox):** استخراج خودکار فیلدهای فاکتور با هوش مصنوعی | اسپرینت ۴ | ✅ **تکمیل شده (۱۰۰٪)** | آماده در سورس کد |
